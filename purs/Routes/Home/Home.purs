...
import SolidJS.Basic.Start (a, suspense)
    ...
    pure
      $ suspense (D.text "lol")
          [ D.div
              ...
              , D.main
                  { class: "news-list" }
                  [ show_ (createMemo \_ -> (not (isUndefined $ toUndefined $ access stories)) && (length $ access stories) > 0) (D.text $ createMemo \_ -> "No " <> access typ <> " found")
                      [ D.ul {}
